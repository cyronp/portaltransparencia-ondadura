...
export default function SlideDurationChart({ durationRanges }: SlideDurationChartProps) {
  return (
    <div className="flex-[0_0_100%] min-w-0 w-full h-full flex items-center justify-center p-0">
      <div className="w-full h-full flex flex-col justify-center px-6 sm:px-16 pt-16 pb-20 max-lg:landscape:pt-10 max-lg:landscape:pb-20 sm:pt-20 sm:pb-24 overflow-y-auto">
